...
const DEMO_DATA = [
  {
    ...
    content:
      "This place is exactly like the picture posted on Travel Lounge. Great service, we had a great stay!",
  },
  {
    id: 2,
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="Let's see what people think of Travel Lounge" isCenter>
